...
# maybe for this workflow don't copy to bristol and just work on lxbatch???
...
localLocation = "/hdfs/user/jt15104/copiesFromEOS/singleMuon2016_v70p1/"
...
# note that it will not run in'list' order
subDirDict = {
